...
export const order = defineType({
    ...
    fields: [
        ...
        defineField({
            name: 'shippingOriginDane',
            title: 'Código DANE Origen',
            type: 'string',
            group: 'details',
        }),
        defineField({
            name: 'shippingDestinationDane',
            title: 'Código DANE Destino',
            type: 'string',
            group: 'details',
        }),
        defineField({
            name: 'shippingQuoteId',
            title: 'ID Cotización Coordinadora',
            type: 'string',
            group: 'details',
        }),
        defineField({
            name: 'shippingQuotedAt',
            title: 'Fecha de Cotización de Envío',
            type: 'datetime',
            group: 'details',
        }),
        defineField({
